 ...
 */
@Service
public class SaveDestroyProductProcessor implements Processor {
    ...
    public void process(ProductChangeContext context) {
        ...
        if (CollectionUtils.isEmpty(context.getNeedDestory()) || productChangeRecord == null) {
            return;
        }
        //对销毁的商品进行处理
        ...
        for(ChangeProductVo changeProductVo:context.getNeedDestory()){
